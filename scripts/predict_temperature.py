...
def parse_arguments():
    ...
    input_group.add_argument("--fasta-file", type=str,
...
class TemperaturePredictor:
    ...
    def predict_batch(self, sequences: List[str], max_length: int = 1000) -> List[float]:
        """
...
def main():
    ...
    if args.sequence:
        ...
        # Print summary
        temperatures = [r['predicted_temperature'] for r in results if r['predicted_temperature'] is not None]
